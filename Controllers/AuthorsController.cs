...
namespace BookStore.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchFirstName, string searchLastName, string searchNationality)
        {
            ...
            {
                authors = authors.Where(a => a.FirstName.Contains(searchFirstName));
            }

            if (!string.IsNullOrEmpty(searchLastName))
            {
                authors = authors.Where(a => a.LastName.Contains(searchLastName));
            }

            if (!string.IsNullOrEmpty(searchNationality))
            {
                authors = authors.Where(a => a.Nationality.Contains(searchNationality));
            }
